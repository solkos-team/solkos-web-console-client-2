...
//       );
//       console.log(data);
//       console.log(data[0].coincidence);
//       console.log(data[0].found_in);
...
//       // const quotedCoincidenceArray = coincidenceArray.map(
//       //   (item) => `"${item}"`
//       // );
//       // const quotedCoincidenceString = quotedCoincidenceArray.join(",");
//       // console.log(quotedCoincidenceString);
