...
//     // Verificar si el valor proviene del modal abierto y contiene comas
//     if (variableGuardada !== "" && variableGuardada !== null) {
//       // Verifica el valor que se va a procesar
//       console.log("Valor a procesar:", variableGuardada);

//       const splitValues = variableGuardada
//         .split(",")
//         .map((item) => item.trim());

//       // Verifica los valores divididos
//       console.log("Valores divididos:", splitValues);
...
//     // Verificar si valorclic no es nulo y procesarlo
//     if (valorclic !== null) {
//       // Verifica el valor que se va a procesar
//       console.log("Valor a procesar:", valorclic);

//       const splitValues = valorclic.split(",").map((item) => item.trim());
...
//   useEffect(() => {
//     if (valorclic != null) {
//       verSelectData(valorclic);
//       window.location.replace(window.location.href);
//       localStorage.removeItem("selectedArea"); // Limpiar valor antes de recargar
//     }
//   }, [valorclic]);
...
// VERSION COMPLETA PERO HACE DOS WINDOW RELOAD
