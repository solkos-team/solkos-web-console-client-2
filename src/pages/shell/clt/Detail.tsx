            ...
            {isMobile && coolersData ? (
              ...
              <>
                <div className="detail_image_info_data">
                  <div className="detail_image_show" style={{ position: 'relative' }}>
                    {isLoading ? (
                      <div style={{ width: "50%", height: "50%", marginLeft: "2rem" }}>
                      ...
                      <>
                        <img
                          ...
                          style={{
                            opacity: coolersData?.vault_markers != null ?
                              getVaultDate(coolersData?.vault_markers).flag ? '0.2' : '' : ''
                          }}
                        />
                        {coolersData?.vault_markers != null && getVaultDate(coolersData?.vault_markers).flag && (
                          <div style={{
                            position: 'absolute',
                            top: '50%',
                            left: '50%',
