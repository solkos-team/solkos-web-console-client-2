...
export default function Coolers() {
  ...
  return (
    <div>
      ...
      <br></br>
      <div className="clt_principal">
        <div className="clt_header">
          <section className="insights_title">
            <div className="clt_title_h1" >Cooler Life Tracking</div>
            <HeaderInsights
              title={"Cooler Life Tracking"}
              description={
            ...
            >
              <table>
                  ...
                  <tr>
                    ...
                    <th scope="col">
                      ...
                      >
                        Última visita
                        <img
                          src={`../../sampleData/${changeAsc == false
                              ? "sort-descending.svg"
                              : "sort-ascending.svg"
                            }`}
                          alt="Descripción de la imagen"
                ...
                {coolersData != undefined ? (
                  <tbody>
                    {coolersData
                      .filter((cooler) => cooler?.status !== "No encontrado")
                      .map((cooler, index) => (
                        <tr
                          key={index}
                        // onClick={() => {
