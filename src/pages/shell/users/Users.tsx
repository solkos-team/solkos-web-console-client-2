...
export default function Users() {
  ...
  const [deleteStatus, setDeleteStatus] = useState(false); // Estado para indicar si la eliminación fue exitosa o no
    ...
    <div>
      ...
      {isDeleteAlertOpen && (
        ...
        >
          ...
          >
            <button
              onClick={() => setIsDeleteAlertOpen(false)} // Cambiado de setIsDelete(false) a setIsDeleteAlertOpen(false)
              style={{
                position: "absolute",
                top: "5px", // Ajusta la posición para que no se superponga al borde
                right: "5px", // Ajusta la posición para que no se superponga al borde
                background: "none",
                border: "none",
                fontSize: "1.5rem",
                cursor: "pointer",
