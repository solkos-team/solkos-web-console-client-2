...
import { PaginationcallCenter } from "../../../components/Pagination/PaginationcallCenter";
...
export default function CoolersCC() {
              ...
              <tbody>
                {coolersData.map((cooler, index) => (
                  ...
                  >
                    ...
                    <td data-label="Serie" title={cooler.customer}>
                      {isLoading == true ? (
                        <>
                          <Skeleton height={20} radius="sm" width="90%" />
                        </>
